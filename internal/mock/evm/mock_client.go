...
func (m *MockClientInterface) BalanceAtHash(ctx context.Context, account common.Address, blockHash common.Hash) (*big.Int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientInterfaceMockRecorder) BalanceAtHash(ctx, account, blockHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BalanceAtHash", reflect.TypeOf((*MockClientInterface)(nil).BalanceAtHash), ctx, account, blockHash)
}
...
func (m *MockClientInterface) BlockReceipts(ctx context.Context, blockNrOrHash rpc.BlockNumberOrHash) ([]*types.Receipt, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientInterfaceMockRecorder) BlockReceipts(ctx, blockNrOrHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BlockReceipts", reflect.TypeOf((*MockClientInterface)(nil).BlockReceipts), ctx, blockNrOrHash)
}

// CallContract mocks base method.
func (m *MockClientInterface) CallContract(ctx context.Context, msg ethereum.CallMsg, blockNumber *big.Int) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientInterfaceMockRecorder) CallContract(ctx, msg, blockNumber interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CallContract", reflect.TypeOf((*MockClientInterface)(nil).CallContract), ctx, msg, blockNumber)
}

// CallContractAtHash mocks base method.
func (m *MockClientInterface) CallContractAtHash(ctx context.Context, msg ethereum.CallMsg, blockHash common.Hash) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientInterfaceMockRecorder) CallContractAtHash(ctx, msg, blockHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CallContractAtHash", reflect.TypeOf((*MockClientInterface)(nil).CallContractAtHash), ctx, msg, blockHash)
}
...
func (m *MockClientInterface) CodeAtHash(ctx context.Context, account common.Address, blockHash common.Hash) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientInterfaceMockRecorder) CodeAtHash(ctx, account, blockHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CodeAtHash", reflect.TypeOf((*MockClientInterface)(nil).CodeAtHash), ctx, account, blockHash)
}

// EstimateGas mocks base method.
func (m *MockClientInterface) EstimateGas(ctx context.Context, msg ethereum.CallMsg) (uint64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientInterfaceMockRecorder) EstimateGas(ctx, msg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EstimateGas", reflect.TypeOf((*MockClientInterface)(nil).EstimateGas), ctx, msg)
}
...
func (mr *MockClientInterfaceMockRecorder) FeeHistory(ctx, blockCount, lastBlock, rewardPercentiles interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientInterfaceMockRecorder) NetworkID(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NetworkID", reflect.TypeOf((*MockClientInterface)(nil).NetworkID), ctx)
}
...
func (m *MockClientInterface) NonceAtHash(ctx context.Context, account common.Address, blockHash common.Hash) (uint64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientInterfaceMockRecorder) NonceAtHash(ctx, account, blockHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NonceAtHash", reflect.TypeOf((*MockClientInterface)(nil).NonceAtHash), ctx, account, blockHash)
}

// PeerCount mocks base method.
func (m *MockClientInterface) PeerCount(ctx context.Context) (uint64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientInterfaceMockRecorder) PeerCount(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PeerCount", reflect.TypeOf((*MockClientInterface)(nil).PeerCount), ctx)
}
...
func (m *MockClientInterface) PendingCallContract(ctx context.Context, msg ethereum.CallMsg) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientInterfaceMockRecorder) PendingCallContract(ctx, msg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PendingCallContract", reflect.TypeOf((*MockClientInterface)(nil).PendingCallContract), ctx, msg)
}
...
func (m *MockClientInterface) StorageAtHash(ctx context.Context, account common.Address, key, blockHash common.Hash) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientInterfaceMockRecorder) StorageAtHash(ctx, account, key, blockHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StorageAtHash", reflect.TypeOf((*MockClientInterface)(nil).StorageAtHash), ctx, account, key, blockHash)
}
